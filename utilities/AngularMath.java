 ...
 *      <p>
 *        3/9/2016 --Joe Witcpalek -- Add comments. 
 *      </p>
 * 
 * 
 * @author Derek
...
public class AngularMath {
  ...
  /*
   * 1) see standard comments
   * 2) use tolerance for double compares
   * 3) no need for else if comparisons when they are of the form
   *    if ( a == b )
   *    {
   *    }
   *    else if ( a != b )
