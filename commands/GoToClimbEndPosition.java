...
/**
 * This class moves the arm to the Climb end position
 * 
 * <h1>Change Log: </h1>
 * 
 ...
 *
 */
public class GoToClimbEndPosition extends Command
{
    ...
    {
        SubsystemFactory.getSubsystemFactory().getArm().setState(ArmState.CLIMB_END);
    }
