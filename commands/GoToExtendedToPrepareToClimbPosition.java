...
/**
 * This class moves the arm to the extended to prepare to climb position
 * 
 * <h1>Change Log: </h1>
 * 
 ...
 *
 */
public class GoToExtendedToPrepareToClimbPosition extends Command
{
	 ...
	 * I need an arm
	 */
    public GoToExtendedToPrepareToClimbPosition()
    {
    ...
    {
        SubsystemFactory.getSubsystemFactory().getArm().setState(ArmState.EXTENDED_TO_PREPARE_TO_CLIMB);
    }
