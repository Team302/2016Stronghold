 ...
 * @version version 3: 3/7/2016 -- Joe Witcpalek -- get the joystick from OI
 * 
 * @author Eric Smith and Klayton Smith
 */
public class CubedTankDrive extends Command
{
...
//      m_joystick = new Joystick(RobotMap.DRIVER_CONTROLLER);
        m_joystick = OI.getOI().getDriverJoystick();
    }
    ...
    protected void execute()
    {
        ...
        m_drive.teleopTankDrive(left, right);
    }
    ...
    {
        return -Math.pow(m_joystick.getRawAxis(5), 3.0);
    }
